...
public class Assignment1 {
    ...
    public static void main(String[] args)
    {
    	...
    	String iterativedeeperController = "controllers.iterativedeepersearch.Agent";
...
//        /****** My Task ******/
//        CompetitionParameters.ACTION_TIME = 500000; // no time for finding the whole path
//        ArcadeMachine.runOneGame("examples/gridphysics/bait.txt", "examples/gridphysics/bait_lvl1.txt", true, iterativedeeperController, null, seed, false);
//
//        System.out.println("My task Finish");
